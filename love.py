...
CANVAS_WIDTH = 640  # 画布宽640
CANVAS_HEIGHT = 480  # 画布高480
CANVAS_CENTER_X = CANVAS_WIDTH / 2  # X的中心为1/2的宽
CANVAS_CENTER_Y = CANVAS_HEIGHT / 2  # Y的中心为1/2的高
IMAGE_ENLARGE = 11  # 图像放大
HEART_COLOR = "#FF99CC"  # 心的颜色设置
...
if __name__ == '__main__':
    ...
    Label(root, text="李静怡", bg="black", fg="#FF99CC", font="Helvetic 20 bold").place(
        relx=.5, rely=.5, anchor=CENTER)  # 爱心中心写字
    Label(root, text="By 祖志诚ᏊˊꈊˋᏊ", font=("Helvetica", 18), fg="#c12bec", bg="black").place(
        relx=.8, rely=.8, anchor=CENTER)  # 在右下角署名
    root.mainloop()  # 开始画画
